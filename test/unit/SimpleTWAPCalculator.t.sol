...
contract SimpleTWAPCalculatorTest is Test {
    ...
    function testBasicTWAP() public view {
        ...
        uint256 amount = calculator.getMakingAmount(order, "", bytes32(0), address(0), 0, order.makingAmount, extraData);
    ...
    function testTWAPExpired() public {
        ...
        SimpleTWAPCalculator.TWAPData memory twapData = SimpleTWAPCalculator.TWAPData({
            startTime: 10_000, // Fixed timestamp in the past
        ...
        calculator.getMakingAmount(order, "", bytes32(0), address(0), 0, order.makingAmount, extraData);
    }
}
