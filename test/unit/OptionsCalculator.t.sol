...
contract OptionsCalculatorTest is Test {
    ...
    function testCreateCallOption() public {
        ...
        IOrderMixin.Order memory order = _createSellOrder(10e18, 21_000e6); // Sell 10 ETH for 21,000 USDC
        ...
        vm.prank(BOB);
        bytes32 optionId = optionsCalc.createCallOption(order, orderHash, strikePrice, expiration, premium);
    ...
    function testCreatePutOption() public {
        ...
        vm.prank(CAROL);
        bytes32 optionId = optionsCalc.createPutOption(order, orderHash, strikePrice, expiration, premium);
    ...
    function testProfitableCallExercise() public {
        ...
        IOrderMixin.Order memory order = _createSellOrder(10e18, 21_000e6);
    ...
    function testUniversalExerciseFunction() public {
        ...
        vm.prank(BOB);
        bytes32 callOptionId =
            optionsCalc.createCallOption(sellOrder, keccak256("call_universal"), 1950e6, block.timestamp + 7 days, 25e6);

        vm.prank(CAROL);
        bytes32 putOptionId =
            optionsCalc.createPutOption(buyOrder, keccak256("put_universal"), 1850e6, block.timestamp + 7 days, 25e6);
    ...
    function testOptionStatusTracking() public {
        ...
        vm.prank(BOB);
        bytes32 optionId = optionsCalc.createCallOption(order, orderHash, 1900e6, block.timestamp + 7 days, 50e6);
        ...
        console.log("Time to Expiration:", status.timeToExpiration / 86_400, "days");
    ...
    function testMultipleOptionsStrategies() public {
        ...
        IOrderMixin.Order memory sellOrder = _createSellOrder(10e18, 20_000e6); // $2,000/ETH
        IOrderMixin.Order memory buyOrder = _createBuyOrder(10e18, 18_000e6); // $1,800/ETH
    ...
    function testOneinchIntegration() public {
        ...
        IOrderMixin.Order memory order = _createSellOrder(10e18, 20_000e6);
        ...
        uint256 makingAmountInWindow = optionsCalc.getMakingAmount(order, "", orderHash, BOB, 5e18, 10e18, extraData);
    ...
    function testCannotExerciseAfterExpiry() public {
        ...
        vm.prank(BOB);
        bytes32 optionId = optionsCalc.createCallOption(order, orderHash, 1900e6, block.timestamp + 1 days, 50e6);
