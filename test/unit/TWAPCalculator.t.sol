...
contract TWAPCalculatorTest is Test {
    ...
    function testBasicTWAPCalculation() public view {
        ...
        uint256 makingAmount = calculator.getMakingAmount(order, "", bytes32(0), address(0), 200e18, 1000e18, extraData);
    ...
    function testTWAPWithRandomization() public view {
        ...
        uint256 makingAmount1 =
            calculator.getMakingAmount(order, "", bytes32(uint256(1)), address(0), 200e18, 1000e18, extraData);

        uint256 makingAmount2 =
            calculator.getMakingAmount(order, "", bytes32(uint256(2)), address(0), 200e18, 1000e18, extraData);
    ...
    function testTWAPExecutionExpired() public {
        ...
        vm.warp(10_000); // Simulate block.timestamp = 10000
        ...
        calculator.getMakingAmount(order, "", bytes32(0), address(0), 100e18, 0, extraData);
    }
    ...
    function testGetTWAPStatus() public view {
        ...
        (bool isActive,, uint256 remainingIntervals, uint256 nextExecutionTime) = calculator.getTWAPStatus(twapData);
    ...
    function testInvalidTWAPData() public {
        ...
        calculator.getMakingAmount(order, "", bytes32(0), address(0), 200e18, 1000e18, extraData);
    }
}
