...
contract VolatilityCalculatorTest is Test {
    ...
    function testHighVolatilityReduction() public view {
        ...
        uint256 makingAmount = calculator.getMakingAmount(order, "", bytes32(0), address(0), 100e18, 1000e18, extraData);
    ...
    function testVolatilityTooHigh() public {
        ...
        calculator.getMakingAmount(order, "", bytes32(0), address(0), 100e18, 1000e18, extraData);
    }
