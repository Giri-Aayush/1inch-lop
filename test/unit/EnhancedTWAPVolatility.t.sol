...
contract EnhancedTWAPVolatilityTest is Test {
    ...
    function testTWAPVolatilityIntegration() public view {
        ...
        uint256 amount = twapExecutor.getMakingAmount(
            order,
            "",
            keccak256("test"),
            address(0),
    ...
    function testRandomizedExecution() public view {
        ...
        uint256 amount1 = twapExecutor.getMakingAmount(
            order, "", keccak256("hash1"), address(0), 50e18, 1000e18, extraData
        );
        
        uint256 amount2 = twapExecutor.getMakingAmount(
            order, "", keccak256("hash2"), address(0), 50e18, 1000e18, extraData
        );
    ...
    function _createVolatilityData() 
        internal view returns (EnhancedVolatilityCalculator.VolatilityData memory) 
    {
    ...
    function _createCombinedData() 
        internal view returns (EnhancedTWAPVolatilityExecutor.CombinedStrategyData memory) 
    {
        EnhancedTWAPVolatilityExecutor.TWAPData memory twapData = EnhancedTWAPVolatilityExecutor.TWAPData({
            startTime: block.timestamp,
            duration: 3600,
        ...
        return EnhancedTWAPVolatilityExecutor.CombinedStrategyData({
            twap: twapData,
            volatility: _createVolatilityData()
        });
    }
}
