...
contract TWAPExecutionTests is BaseMainnetTest {
    ...
    function test_TWAPExecution_ShortDurationConfiguration() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 1 ether, 3 ether, extraData
        );
    ...
    function test_TWAPExecution_MediumDurationConfiguration() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 2 ether, 10 ether, extraData
        );
    ...
    function test_TWAPExecution_LongDurationConfiguration() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 5 ether, 20 ether, extraData
        );
    ...
    function test_TWAPExecution_TimeProgressionAffectsAmount() public {
        ...
        for (uint i = 0; i < 5; i++) {
            ...
            amounts[i] = twapExecutor.getMakingAmount(
                order, "", orderHash, bob, 2 ether, remainingAmount, extraData
            );
    ...
    function test_TWAPExecution_AdaptiveIntervalsWithHighVolatility() public {
        ...
        assertLt(nextExecutionTime - twapData.lastExecutionTime, twapData.baseInterval, 
    ...
    function test_TWAPExecution_AdaptiveIntervalsWithLowVolatility() public {
        ...
        assertGt(nextExecutionTime - twapData.lastExecutionTime, twapData.baseInterval, 
    ...
    function test_CalculateExecutionState_ComprehensiveAnalysis() public {
        ...
        EnhancedTWAPVolatilityExecutor.ExecutionState memory state = twapExecutor.calculateExecutionState(
            order,
            orderHash,
            2 ether,
            8 ether,
    ...
    function test_TWAPExecution_EmergencyPauseStopsExecution() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 1 ether, 5 ether, extraData
        );
    ...
    function test_ShouldPauseExecution_WorksCorrectly() public {
        ...
        EnhancedTWAPVolatilityExecutor.CombinedStrategyData memory normalData = _createCombinedStrategyData(
            _createMediumTWAPData(),
            _createNormalVolatilityData()
        );
        ...
        EnhancedTWAPVolatilityExecutor.CombinedStrategyData memory emergencyData = _createCombinedStrategyData(
            _createMediumTWAPData(),
            emergencyVolData
        );
    ...
    function test_TWAPExecution_VerySmallOrder() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 0.05 ether, 0.1 ether, extraData
        );
    ...
    function test_TWAPExecution_VeryLargeOrder() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 50 ether, 1000 ether, extraData
        );
    ...
    function test_TWAPExecution_SingleInterval() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 1 ether, 2 ether, extraData
        );
    ...
    function test_TWAPExecution_DifferentTokenPairs() public {
        ...
        IOrderMixin.Order memory usdcOrder = _createMultiAssetOrder(USDC, WETH, 10000e6, 5 ether);
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            usdcOrder, "", orderHash, bob, 2000e6, 10000e6, extraData
        );
        ...
        makingAmount = twapExecutor.getMakingAmount(
            usdtOrder, "", orderHash, bob, 1600e6, 8000e6, extraData
        );
    ...
    function test_TWAPExecution_HighFrequencyIntervals() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            order, "", orderHash, bob, 1 ether, 12 ether, extraData
        );
    ...
    function test_TWAPExecution_ExtremePriceVariations() public {
        ...
        IOrderMixin.Order memory highPriceOrder = _createETHSellOrder(1 ether, 10000e6); // $10,000 per ETH
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(
            highPriceOrder, "", orderHash, bob, 0.1 ether, 1 ether, extraData
        );
        ...
        makingAmount = twapExecutor.getMakingAmount(
            lowPriceOrder, "", orderHash, bob, 1 ether, 10 ether, extraData
        );
    ...
    function test_GetTakingAmount_ProportionalCalculation() public {
        ...
        uint256 takingAmount = twapExecutor.getTakingAmount(
            order, "", orderHash, bob, makingAmount, 10 ether, extraData
        );
    ...
    function test_1inchInterface_AllMethodsWork() public {
        ...
        uint256 takingAmount = twapExecutor.getTakingAmount(
            order, "", orderHash, bob, makingAmount, 5 ether, extraData
        );
        ...
        assertGt(nextTime, block.timestamp, "Next execution time should be in future");
