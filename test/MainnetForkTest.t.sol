...
contract MainnetForkTest is Test {
    ...
    function test_TWAPExecution_ValidConfiguration() public {
        ...
        uint256 makingAmount = twapExecutor.getMakingAmount(order, "", orderHash, bob, 1 ether, 10 ether, extraData);
    ...
    function test_OptionsCreation_CallOption() public {
        ...
        vm.prank(bob);
        bytes32 optionId = optionsCalc.createCallOption(order, orderHash, 2100e6, block.timestamp + 7 days, 100e6);
    ...
    function test_OptionsCreation_PutOption() public {
        ...
        vm.prank(carol);
        bytes32 optionId = optionsCalc.createPutOption(buyOrder, orderHash, 1900e6, block.timestamp + 14 days, 75e6);
    ...
    function test_Integration_1inchCompatibility() public {
        ...
        uint256 makingAmount =
            volatilityCalc.getMakingAmount(order, "", keccak256("test"), bob, 0.5 ether, 1 ether, extraData);

        // Test getTakingAmount interface
        uint256 takingAmount =
            volatilityCalc.getTakingAmount(order, "", keccak256("test"), bob, 0.5 ether, 1 ether, extraData);
    ...
    function test_Integration_GasEfficiency() public {
        ...
        assertLt(gasUsed, 50_000, "Volatility calculation should be gas efficient");
        ...
        gasStart = gasleft();
        twapExecutor.getMakingAmount(order, "", keccak256("test"), bob, 0.5 ether, 1 ether, abi.encode(combined));
        gasUsed = gasStart - gasleft();

        assertLt(gasUsed, 100_000, "TWAP calculation should be gas efficient");
    }
    ...
    function _fundTestAccounts() internal {
        ...
        IERC20(USDC).transfer(bob, 25_000e6);
        vm.stopPrank();
    }
